...
Los [sistemas ATS](/blog/cv-ats-guia-completa) también analizan tus competencias lingüísticas. Así puedes optimizar esta sección:
...
Las barras de progreso, las estrellas o los porcentajes son populares en CV visuales, pero los [ATS no pueden leerlos](/blog/errores-cv-ats). Utiliza siempre texto además de cualquier elemento visual.

### Adapta a cada oferta

¿La oferta exige "alemán fluido"? Pon el alemán en primer lugar en tu sección de idiomas. El orden en que listas tus idiomas envía una señal, tanto al ATS como al reclutador humano. Un [análisis de compatibilidad](/blog/puntuacion-compatibilidad-cv) te permite verificar que tus idiomas están correctamente destacados para cada puesto concreto.
...
El editor en línea de [FitMyCV](https://app.fitmycv.io) integra funcionalidades dedicadas a la presentación de competencias lingüísticas:
...
- **Optimización de la [compatibilidad ATS](/blog/cv-compatible-ats-formato)**: las palabras clave lingüísticas se formatean para ser correctamente interpretadas por los sistemas de filtrado automático.
...
[Optimiza la presentación de tus idiomas con FitMyCV. Empieza gratis con 15 créditos.](https://app.fitmycv.io)
