...
[ATS systems](/blog/ats-resume-complete-guide) also parse your language skills. Here's how to optimize this section:
...
Progress bars, stars, and percentages are popular in visual resumes, but [ATS systems cannot read them](/blog/ats-resume-mistakes). Always use text alongside any visual elements.

### Tailor to Each Application

Does the posting require "fluent German"? Put German first in your languages section. The order in which you list languages sends a signal to both the ATS and the human recruiter. Running a [compatibility analysis](/blog/resume-match-score-explained) helps you verify that your language skills are highlighted correctly for each specific role.
...
The online editor in [FitMyCV](https://app.fitmycv.io) includes features designed for language skill presentation:
...
- **[ATS compatibility](/blog/ats-compatible-resume-format) optimization**: Language keywords are formatted to be correctly interpreted by automated filtering systems.
...
[Optimize how you present your language skills with FitMyCV. Start free with 15 credits.](https://app.fitmycv.io)
