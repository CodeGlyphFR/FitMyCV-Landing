...
Contrairement aux [soft skills](/blog/soft-skills-cv-ats), les hard skills se prêtent parfaitement au matching automatique. L'ATS compare les termes de votre CV avec ceux de l'offre, mot pour mot. Si l'offre demande "Kubernetes" et que votre CV ne contient que "orchestration de conteneurs", le match ne se fait pas.
...
Pour un aperçu global du fonctionnement des ATS, consultez notre [guide complet](/blog/cv-ats-guide-complet).
...
**Bases de données :** PostgreSQL, MongoDB, Cassandra, Redis
**Outils :** dbt, Terraform, Docker, Git
**Méthodologies :** DataOps, CI/CD, Agile (Scrum)
...
Votre [résumé professionnel](/blog/resume-professionnel-cv) doit contenir vos 3-5 compétences techniques les plus importantes. Ce sont les compétences qui vous définissent en tant que professionnel.
...
Les étoiles, les barres, les pourcentages visuels sont invisibles pour l'ATS. C'est l'une des [erreurs de formatage les plus courantes](/blog/erreurs-cv-ats).
...
Pour adapter ces compétences à votre secteur spécifique, consultez notre article sur [les CV ATS par secteur](/blog/cv-ats-par-secteur).
...
Assurez-vous aussi que votre CV respecte les [standards de formatage ATS](/blog/cv-compatible-ats-format) pour que vos compétences soient correctement lues par le logiciel.
...
[Vérifier mes compétences techniques](https://app.fitmycv.io)
