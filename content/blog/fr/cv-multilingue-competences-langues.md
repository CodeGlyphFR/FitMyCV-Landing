...
Les [systèmes ATS](/blog/cv-ats-guide-complet) analysent aussi vos compétences linguistiques. Voici comment optimiser cette section :
...
Les barres de progression, les étoiles ou les pourcentages sont populaires dans les CV visuels, mais les [ATS ne peuvent pas les lire](/blog/erreurs-cv-ats). Utilisez toujours du texte en complément.
...
L'éditeur en ligne de [FitMyCV](https://app.fitmycv.io) intègre des fonctionnalités dédiées à la présentation de vos compétences linguistiques :
...
- **Optimisation de la [compatibilité ATS](/blog/cv-compatible-ats-format)** : les mots-clés linguistiques sont formatés pour être correctement interprétés par les systèmes de filtrage automatique.
...
[Optimisez la présentation de vos langues avec FitMyCV. Commencez gratuitement avec 15 crédits.](https://app.fitmycv.io)
