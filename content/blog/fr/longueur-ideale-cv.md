...
## La question qui divise les candidats

"Mon CV doit-il tenir sur une page ?" C'est probablement la question la plus posée dans le monde du recrutement. Et pour cause : la réponse n'est pas unique. Elle dépend de votre profil, de votre secteur, du poste visé et du pays dans lequel vous postulez.

Ce qui est certain, c'est que la longueur de votre CV n'est jamais neutre. Un CV trop court peut donner l'impression que vous manquez d'expérience. Un CV trop long risque de noyer l'information essentielle et de perdre l'attention du recruteur.
...
## Le CV de deux pages : pour qui ?

### Les profils concernés

Le CV de deux pages se justifie quand votre parcours le nécessite :

- **Professionnels confirmés** avec plus de 5 ans d'expérience dans des postes pertinents.
...
### 1. Combien d'années d'expérience pertinente avez-vous ?

| Expérience | Recommandation |
|-----------|----------------|
| 0-3 ans | 1 page |
| 3-7 ans | 1 à 1,5 page |
| 7-15 ans | 1,5 à 2 pages |
| 15+ ans | 2 pages (jamais plus) |
...
Les recruteurs techniques s'attendent à voir vos technologies, projets et certifications. Un développeur senior avec 10 ans d'expérience aura du mal à tout condenser sur une page sans sacrifier des informations pertinentes.

### 4. Chaque élément de votre CV sert-il votre candidature ?

Relisez chaque bullet point et demandez-vous : "Est-ce que cela aide le recruteur à comprendre pourquoi je suis le bon candidat pour ce poste ?" Si la réponse est non, supprimez-le.
...
### Si votre CV est trop court

- **Développez vos réalisations** avec des chiffres : pourcentages, montants, volumes.
